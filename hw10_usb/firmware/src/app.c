        ...
        case APP_STATE_SCHEDULE_WRITE: 
            ...
            for (k = 0; k < 100; k++) {
                ...
                if (appData.readBuffer[0] == 114) {     // 114 = 'r'
                    ...
                    float gyroX_scaled = gyroX * 0.00366; 
                    float gyroY_scaled = gyroY * 0.00366; 
                    float gyroZ_scaled = gyroZ * 0.00366; 
                    float accelX_scaled = accelX * 0.00366; 
                    float accelY_scaled = accelY * 0.00366; 
                    float accelZ_scaled = accelZ * 0.00366;   

                    len = sprintf(dataOut, "%d %5.2f %5.2f %5.2f %5.2f %5.2f %5.2f\r\n", k, accelX_scaled, accelY_scaled, 
                        accelZ_scaled, gyroX_scaled, gyroY_scaled, gyroZ_scaled);
